...
public class Encyclopedia extends Book { 
    ...
    public static void main(String[] pages) { 
        System.out.print(new Encyclopedia().getMaterial()); //super deðiþkeni getMaterial () öðesinde eriþmek için kullanýldýðýndan, papyrus deðeri döndürülür ve Seçenek A doðru yanýt haline gelir.
        }
